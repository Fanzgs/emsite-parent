...
/**
 * 类PaginationInterceptor.java的实现描述：数据库分页插件，只拦截查询语句.
 * 
 * @author arron 2017年10月30日 下午4:01:30
 */
...
public class PaginationInterceptor extends BaseInterceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (page != null && page.getPageSize() != -1) {
            ...
            //得到总记录数
            page.setCount(SQLHelper
                    .getCount(originalSql, null, mappedStatement, parameterObject, boundSql, log, dbType));
