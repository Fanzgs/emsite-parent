...
/**
 * 类SQLHelper.java的实现描述：SQL工具类
 * 
 * @author arron 2017年10月30日 下午4:01:57
 */
public class SQLHelper {
    ...
    public static int getCount(final String sql, final Connection connection, final MappedStatement mappedStatement,
                               final Object parameterObject, final BoundSql boundSql, Log log, String dbType)
            throws SQLException {
        String dbName = dbType;
