 ...
 */
package com.empire.emsite.modules.gen.util;
...
import com.empire.emsite.common.config.Global;
import com.empire.emsite.common.mapper.JaxbMapper;
import com.empire.emsite.common.utils.DateUtils;
import com.empire.emsite.common.utils.FileUtils;
import com.empire.emsite.common.utils.FreeMarkers;
import com.empire.emsite.common.utils.StringUtils;
import com.empire.emsite.modules.gen.entity.GenCategory;
...
/**
 * 类GenDbsUtils.java的实现描述：代码生成工具类
 * 
 * @author arron 2017年10月30日 下午4:27:35
 */
public class GenDbsUtils {

    private static Logger logger = LoggerFactory.getLogger(GenDbsUtils.class);
        ...
        try {
            ...
            if (file != null) {
                return file.getAbsolutePath()
                        + File.separator
                        + StringUtils.replaceEach(GenDbsUtils.class.getName(), new String[] {
                                "util." + GenDbsUtils.class.getSimpleName(), "." }, new String[] { "template",
                                File.separator });
            }
        } catch (Exception e) {
            logger.error("{}", e);
     ...
     * @return
     */
    public static Map<String, Object> getDataModel(GenScheme genScheme, User user) {
        ...
        model.put("functionAuthor",
                StringUtils.isNotBlank(genScheme.getFunctionAuthor()) ? genScheme.getFunctionAuthor() : user.getName());
        model.put("functionVersion", DateUtils.getDate());
        model.put("functionDate", DateUtils.getDate("yyyy年MM月dd日 a HH:mm:ss"));
        model.put(
                "urlPrefix",
